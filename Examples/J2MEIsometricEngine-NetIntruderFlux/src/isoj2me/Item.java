...
public class Item {
  ...
  /**
   * This draw the Item at given coordinates on given Graphics. This method also change the current frame (if more than one) for the current action.
   * @param x x
   * @param y y
  ...
  /**
   * This return the name that identify the action that is performed in this moment by the Item
  ...
  /**
   * Set the current action for this Item. The action have to be already in the actions list
