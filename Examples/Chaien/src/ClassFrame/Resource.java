...
public class Resource {
    ...
    public static final int IMG_NOBITA              = count++;
...
//                "/PNG/button/button_pause.png",
    ...
    private static final String[] soundsNames = 
    {   "/sound/menu.mid",
        "/sound/play.mid",
        "/sound/gameover.mid",
        "/sound/up.wav",
...
//    public static final int SOUND_WIN           = 7;
    ...
    public static final int[] menuArrayImages       = { IMG_BG_MENU, IMG_BUTTON_MENU, IMG_TXT_BUTTON_MENU};
    public static final int[] guideArrayImages      = { IMG_BG_OTHER, IMG_TXT_GUIDE, IMG_GUIDE, IMG_BACK };
    public static final int[] aboutArrayImages      = { IMG_BG_OTHER, IMG_TXT_ABOUT, IMG_ABOUT, IMG_BACK } ;
    ...
    public static final int[] gamePlayArrayImages   = {   IMG_SMALL_NUMBER,     IMG_CHAIEN,         IMG_CHAIEN_FAIL,      IMG_CHAIEN_SING,
                                                           IMG_NOBITA,          IMG_NOBITA_FAIL,    IMG_ITEM, IMG_ITEM1,
                                                           IMG_MAIN,            IMG_MAIN2,          IMG_MAIN3 };
    public static final int[] pauseArrayImages      = { IMG_PAUSE, IMG_BG_FRAME };
    public static final int[] gameoverArrayImages   = { IMG_GAME_OVER, IMG_BG_FRAME };
