...
public class Constant {
    ...
    public static final int txt_sound_x = 48;
...
//    public static final int buttonlt_h = 32;
    ...
    public static final int menu1_x = 177;
    public static final int menu1_y = 58;
    public static final int menu2_x = 147;
    public static final int menu2_y = 52;
//    public static final int menu_w = 170;
//    public static final int menu_h = 30;
    public static final int menu_d = 25;
...
//    public static final int buttAgree_y = 254;
    //HighScore
    public static final int txt_score_y = 10;
    ...
    public static final int txt_setting_y = 10;
    public static final int seek_bar_x = 40;
    public static final int seek_bar_y = 130;
    public static final int seek_bar_d = 130;
    public static final int sound_x = 110;
    public static final int sound_y = 130;
//    public static final int guide_y = 90;
    //guide
    public static final int txt_guide_y = 10;
    public static final int guide_y = 68;
    //about
    public static final int txt_about_y = 10;
    public static final int about_y = 63;
    //exit
    ...
    public static final int txt_frame_x = 48;
    public static final int txt_frame_y = 52;
