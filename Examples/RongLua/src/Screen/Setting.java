...
//        canvas.getImage().drawImage(g, canvas, Resource.IMG_VOLUME, Constant.sound_x + (CanvasGame.musicLevel*130)/100, Constant.sound_y);        
        if(CanvasGame.musicLevel==100)
        {
            canvas.getImage().drawImagePart(g, canvas, Resource.IMG_VOLUME, Constant.sound_x, Constant.sound_y, 0, 0, CanvasGame.musicLevel/20*21+2, 15);
        }
        else
        {
            canvas.getImage().drawImagePart(g, canvas, Resource.IMG_VOLUME, Constant.sound_x, Constant.sound_y, 0, 0, CanvasGame.musicLevel/20*21, 15);
        }
